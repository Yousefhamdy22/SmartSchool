...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".menu-logo img").attr("src", "assets/images/logosm.png");
		jQuery(".header-transparent .menu-logo img").attr("src", "assets/images/logosm.png");
		jQuery(".pt-logo img").attr("src", "assets/images/logosm.png");
        return false;
    });
